...
class CoalDataset(Dataset):
    def __init__(self, root='data/coal', file='coal.npz', meta='data/train_raw.txt', frames_per_clip=3, num_points=16384, train=False):
    ...
    def __getitem__(self, index):
        ...
        return clip.astype(np.float32), rgb.astype(np.float32), pre.astype(np.float32), index
